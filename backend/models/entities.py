...
class Patient(Base):
    ...
    profile_signature: Mapped[str | None] = mapped_column(String(512), nullable=True)
...
class Scan(Base):
    ...
    volume_manifest_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
    corrected_mask_path: Mapped[str | None] = mapped_column(String(512), nullable=True)
    ...
    uncertainty_std: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    stage_method: Mapped[str | None] = mapped_column(String(64), nullable=True)
    ...
    xai_method: Mapped[str | None] = mapped_column(String(64), nullable=True)
